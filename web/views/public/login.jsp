        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataJSON.message != null) {
                    $('#message').css('display', 'block');
                    $('#message').html('Login ou Senha inv�lidos<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true"><i class="material-icons">clear</i></span></button>').addClass('alert-danger').removeClass('alert-info');
                } else {
                    $('#message').css('display', 'block');
